...
public class DamageTextEffect : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (canvasGroup != null)
        {
            ...
            float randomY = useGravity ? Random.Range(0.5f, 1f) : Random.Range(0.8f, 1.5f);
    ...
    void Update()
    {
        ...
        if (timer >= lifeTime * 0.5f)
        {
            ...
            {
                float alpha = Mathf.Lerp(originalColor.a, 0f, (timer - lifeTime * 0.5f));
    ...
    public void Initialiazed(bool critical , bool statusEffect)
    {
        isCritical = critical;
